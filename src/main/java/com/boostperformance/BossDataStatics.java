...
enum BossDataStatics
{
     ...
     */
    BossDataStatics(int spawnFormId, int finalFormId, Set<Integer> validPartners, String shortName, String fullName, double spawnSeconds, int deathAnimationId, double ehb, WorldPoint spawnLocation, int size)
    {
